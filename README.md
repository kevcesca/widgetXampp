...
- **Nueva vista para generar estados de cuenta**: Se agrega la vista que permitira generar estados de cuenta.
- **Botón de inicio mejorado**: El botón de inicio ahora regresa al inicio de la respectiva campaña.
...
- **Eliminación del botón de agenda**: Se ha eliminado el botón de agenda de la barra lateral.
...
- **Actualización de información de precios**: Se han realizado ajustes la información de precios en las campañas.
- **Simplificación de opciones del propietario**: Ahora solo se muestra la opción para el titular, eliminando las dems opciones relacionadas con el propietario.
- **Campaña Autotal**: Ya no se solicitan datos del vehículo ni del propietario.
